...
if __name__ == "__main__":
    ...
    for path_fea in pathomics_lst:
        ...
        sns.violinplot(data=fuse_fea_df, x = "Stages", y=path_fea, hue = "Dataset", order=stage_list,  orient='v')
        # axes.set_ylim(0, 1.0)
        plt.legend(loc = "best")
        plt.tight_layout()
        trend_plot_path = os.path.join(path_trend_dir, "{}-Trend-Dataset{}".format(path_fea, args.plot_format))
